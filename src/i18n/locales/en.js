...
const en = {
  translation: {
    ...
    new_items_count: "{{count}} new",
    conflicts_count: "{{count}} conflicts",
    current: "Current",
    incoming: "Incoming",
    no_changes_preview: "No changes to preview",
    import_summary:
      "Importing {{newCount}} new and {{overwriteCount}} updated items",
    relationship_orphan_warning:
      "{{count}} relationships reference tables not selected for import",
    ...
    no_items_to_import: "No items to import in this category",
    back_to_import: "Back",
  },
};
