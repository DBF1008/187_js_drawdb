...
const en = {
  translation: {
    ...
    issue_locate: "Go to object",
    issue_fix: "Quick fix",
    issue_fixed: "Issue fixed",
    issue_cat_table: "Tables",
    issue_cat_field: "Fields",
    issue_cat_index: "Indices",
    issue_cat_type: "Types",
    issue_cat_enum: "Enums",
    issue_cat_relationship: "Relationships",
    name: "Name",
    type: "Type",
    null: "Null",
    not_null: "Not null",
