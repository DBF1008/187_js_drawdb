...
const en = {
  translation: {
    ...
    restore_backup_description:
      "Upload a backup ZIP previously generated by \"Export saved data\" to restore your diagrams and custom templates.",
    restore: "Restore",
    restore_successful: "Restore completed successfully",
    restore_refresh_note:
      "The diagrams and templates lists will update automatically. If you are currently editing a restored diagram, open it again from the File menu to load the latest version.",
    duplicate_handling: "When a diagram or template already exists:",
    overwrite_existing: "Overwrite existing",
    skip_existing: "Skip existing",
    diagrams_added: "{{count}} diagram(s) added",
    diagrams_overwritten: "{{count}} diagram(s) overwritten",
    diagrams_skipped: "{{count}} diagram(s) skipped",
    templates_added: "{{count}} template(s) added",
    templates_overwritten: "{{count}} template(s) overwritten",
    templates_skipped: "{{count}} template(s) skipped",
    dbml_view: "DBML view",
    tab_view: "Tab view",
    label: "Label",
