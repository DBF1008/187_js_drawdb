...
const en = {
  translation: {
    ...
    no_matching_issues: "No issues match the current filters.",
    auto_fix: "Auto fix",
    fix_all_of_type: "Fix all",
    add_primary_key: "Add primary key",
    set_default_name: "Set default name",
    clear_default: "Clear default",
    remove_empty_index: "Remove empty index",
    add_placeholder_value: "Add placeholder value",
